/**
 * Full integration tests for README examples using server-as-channel pattern
 * Addresses issue #387: test all examples and code snippets in READMEs
 * 
 * Following the recommendation: "you don't even need a HTTP server running - 
 * a Ucanto server is a channel, so you can pass it to the client as the channel to use."
 */
