...
export default /** @type {{at: API.Selector, data:API.Data, out: API.SelectionResult & {error?: RegExp}}[]} */ ([
  {
    at: /** @type {any} */ ('x'),
    data: { x: 1 },
  ...
  },
  {
    at: '.[].x[]',
    data: [{ x: 1 }, { x: 2 }, { y: 3 }, { x: 4 }],
    out: { error: /TypeError: Can not iterate over number/ },
  },
  {
    at: '.[].xs[]',
    data: [{ xs: [1, 2] }, { xs: [3, 4] }],
  ...
  },
  {
    at: '.xs[0:--2]',
    data: { xs: [1, 2, 3, 4, 5] },
    out: { error: /ParseError.*invalid segment.*--2/ },
  },
  {
    at: '.xs[0:+2]',
    data: { xs: [1, 2, 3, 4, 5] },
  ...
  },
  {
    at: '.xs[0:1]',
    data: { xs: { [0]: 1, [1]: 2, [2]: 3 } },
    out: { error: /Can not slice 0:1 from object/ },
  },
  // index access
  {
    at: '.xs[0]',
  ...
  },
  {
    ...
    out: { error: /Can not access field "length" on Uint8Array/ },
  },
  {
    at: '.t.length',
    data: { t: 'hello' },
  ...
  },
  {
    at: '.t[0]',
    data: { t: 'hello' },
    // This is how jq does it, but perhaps it is better to return 'h' instead ?
    out: { error: /Can not index string with number 0/ },
  },
  ...
  },
  {
    ...
    out: { error: /Can not access field "slice" on Uint8Array/ },
  },
  {
    at: '.q.bar',
    data: { q: { bar: 3 } },
  ...
  },
  {
    at: '.q["bar\\"]',
    data: { q: { bar: true } },
    out: { error: /ParseError.*unterminated string literal/ },
  },
  {
    at: '.q[bar]',
    data: { q: { bar: true } },
