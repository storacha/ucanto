...
import { equalWith, fail, equal } from './util.js'
import { _ as top } from './any.js'

/**
 * Schema representing a link (a.k.a CID) to a CAR file. Enforces CAR codec code and CID v1.
 */
export const CARLink = Schema.Link.match({ code: 0x0202, version: 1 })

export const Space = Schema.DID.match({ method: 'key ' })
